%% Fit psychometric function and assess its goodness-of-fit (cardinal axis, without rotation)
...
% Number of 'Yes' responses for each stimulus level (here, it means "Vertical" responses):
numResponses = [0,3,30,78,120,167,210,233,251,262,267,271,272]; % Note: these are the mean values of asending and descending conditions
...
B = 200; % the number of simulations for the goodness-of-fit test
...
numResponses_asc = [0,0,11,30,49,74,97,111,125,133,135,136,136];
...
% descending sequence -----------------------------------------------------
% Number of 'Yes' responses for each stimulus level:
numResponses_desc = [0,3,19,48,71,93,113,122,126,129,132,135,136];
...
% Set up initial parameter guesses for the fitting process:
initialParams_desc = [1, 15, 0.5, 0]; % [alpha, beta, gamma, lambda]
...
ylabel('Proportion of Vertical Responses'); 
title('Cardinal Axis (Without Rotation)'); 
grid on; 
hold off;  
