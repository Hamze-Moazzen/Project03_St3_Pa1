%% Fit psychometric function and assess its goodness-of-fit (oblique axis, without rotation)
...
% Number of 'Yes' responses for each stimulus level (here, it means "135°" responses):
numResponses = [0,0,6,19,33,72,130,188,234,255,265,268,272]; % Note: these are the mean values of asending and descending conditions
...
numResponses_asc = [0,0,2,5,10,23,48,84,114,126,131,134,136];
...
% descending sequence -----------------------------------------------------
% Number of 'Yes' responses for each stimulus level:
numResponses_desc = [0,0,4,14,23,49,82,104,120,129,134,136,136];
...
ylabel('Proportion of 135° Responses'); 
title('Oblique Axis (Without Rotation)'); 
grid on; 
hold off; 
