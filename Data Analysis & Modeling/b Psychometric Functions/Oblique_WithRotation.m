%% Fit psychometric function and assess its goodness-of-fit (oblique axis, with 90° rotation)
...
numResponses = [0,0,0,11,18,55,128,183,220,247,267,272,272]; % Note: these are the mean values of asending and descending conditions
...
numResponses_asc = [0,0,0,5,7,24,54,84,106,121,133,136,136];
...
% descending sequence -----------------------------------------------------
% Number of 'Yes' responses for each stimulus level:
numResponses_desc = [0,0,0,6,11,31,74,99,114,126,134,136,136];
...
ylabel('Proportion of 45° Responses'); 
title('Oblique Axis (With 90° Rotation)'); 
grid on; 
hold off;  
